...
public:
    ...
    * @author Spencer Banasik
    */
    void set_callback_mouse_movement(std::function<void(WInputContext* wi_context)>&& function) { callback_mouse_move = std::move(function); };
...
private:
    ...
    */
    ...
    std::function<void(WInputContext* wi_context)> callback_mouse_move;
