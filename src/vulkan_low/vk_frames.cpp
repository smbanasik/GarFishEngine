...
gf::vk_frames::ImmediateFrame::ImmediateFrame(vk_core::VKCore* core)
: core_handle(core) {
    VkCommandPoolCreateInfo pool_info = vk_init::command_pool_info(core_handle->graphics_queue_family, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT);
...
gf::vk_frames::ImmediateFrame::~ImmediateFrame() {
...
gf::vk_frames::ImmediateFrame::ImmediateFrame(ImmediateFrame&& other) noexcept 
...
void gf::vk_frames::ImmediateFrame::immediate_submit(std::function<void(VkCommandBuffer cmd)>&& function) {
