...
vk_img::AllocatedImage vk_img::ImageBufferAllocator::create_image(VkExtent3D size, VkFormat format, VkImageUsageFlags usage, bool mipmapped) const {
...
vk_img::AllocatedImage vk_img::ImageBufferAllocator::create_image(void* data, VkExtent3D size, VkFormat format, VkImageUsageFlags usage, bool mipmapped) const {
	int nr_channels = 4;
...
vk_img::AllocatedBuffer vk_img::ImageBufferAllocator::create_buffer(size_t allocation_size, VkBufferUsageFlags flags, VmaMemoryUsage memory_usage) const {
...
void vk_img::ImageBufferAllocator::destroy_image(const AllocatedImage& image) const {
...
void vk_img::ImageBufferAllocator::destroy_buffer(const AllocatedBuffer& buffer) const {
	vmaDestroyBuffer(alloc_handle->allocator, buffer.buffer, buffer.allocation);
}

vk_img::AllocatedImage::AllocatedImage(const AllocatedImage& other)
	: image(other.image),
...
vk_img::AllocatedImage::AllocatedImage(AllocatedImage&& other) noexcept
...
vk_img::AllocatedBuffer::AllocatedBuffer(const AllocatedBuffer& other)
	: buffer(other.buffer),
	allocation(other.allocation),
	info(other.info),
	counter(other.counter),
...
vk_img::AllocatedBuffer::AllocatedBuffer(AllocatedBuffer&& other) noexcept
...
void vk_img::transition_image(VkCommandBuffer cmd, VkImage image, VkImageLayout current_layout, VkImageLayout new_layout) {
...
void vk_img::copy_image_to_image(VkCommandBuffer cmd, VkImage src, VkImage dst, VkExtent2D src_size, VkExtent2D dst_size) {
...
std::optional<vk_img::AllocatedImage> vk_img::load_image_from_path(vk_img::ImageBufferAllocator* allocator, const std::string& file_path) {
