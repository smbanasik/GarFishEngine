...
constexpr std::array<std::string_view, 4> LOG_LEVEL_COLORS{"\033[90m", "\033[37m", "\033[33m",
                                                            "\033[31m"};
...
constexpr uint8_t WRITE_TO_FILE_BIT = 0u;
constexpr uint8_t FILE_LOG_LEVEL_SHIFT = 1u;
constexpr uint8_t OUTPUT_TO_CONSOLE_BIT = 3u;
constexpr uint8_t CONSOLE_LOG_LEVEL_SHIFT = 4u;
constexpr uint8_t TIMESTAMP_LOG_BIT = 6u;
constexpr uint8_t COLOR_BIT = 7u;

constexpr uint8_t WRITE_TO_FILE_MASK = 0b1u << WRITE_TO_FILE_BIT;
constexpr uint8_t FILE_LOG_LEVEL_MASK = 0b11u << FILE_LOG_LEVEL_SHIFT;
constexpr uint8_t OUTPUT_TO_CONSOLE_MASK = 0b1u << OUTPUT_TO_CONSOLE_BIT;
constexpr uint8_t CONSOLE_LOG_LEVEL_MASK = 0b11u << CONSOLE_LOG_LEVEL_SHIFT;
constexpr uint8_t TIMESTAMP_LOG_MASK = 0b1u << TIMESTAMP_LOG_BIT;
constexpr uint8_t COLOR_MASK = 0b1u << COLOR_BIT;
}
